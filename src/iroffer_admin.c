...
{2,2,method_allow_all,a_queue,         "QUEUE","nick n [net]","Queues pack <n> for <nick> in main queue"},
{2,2,method_allow_all,a_iqueue,        "IQUEUE","nick n [net]","Queues pack <n> for <nick> in idle queue"},
